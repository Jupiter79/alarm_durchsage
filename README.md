...
Ich (Sergio Huainigg von der Feuerwehr Spittal/Drau) entwickle und betreue das System. Falls es Probleme, Vorschläge oder Fragen gibt, bitte per E-Mail an mich wenden: **admin@ff-spittal.at**. Alternativ können neue Features oder Probleme jederzeit mittels eines Issues auf der GitHub-Seite eröffnet werden.
